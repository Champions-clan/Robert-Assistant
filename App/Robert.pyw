        ...
        if "alarm" in statement or "reminder" in statement:
            ...
            while(1 == 1):
                if(alarmH == datetime.datetime.now().hour and alarmM == datetime.datetime.now().minute):
                    print(Reminder)
                    notify.show_toast("Notification", "Reminder!!!", duration=5, icon_path="C:\\Users\\acer\\Desktop\\facerecong\\Robert_Virtual_Assistant-master\\Robert_Virtual_Assistant-master\\Asserts\\logo.ico") and playsound(
                        "C:\\Users\\acer\\Desktop\\facerecong\\Robert_Virtual_Assistant-master\\Robert_Virtual_Assistant-master\\Asserts\\beep.wav")
                    break
